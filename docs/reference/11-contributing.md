...
For Guide and IDE configuration editing, see the [customization coordinator contract](21-customization-contract.md). It owns candidate generation, admission, installation replay, and recovery.
