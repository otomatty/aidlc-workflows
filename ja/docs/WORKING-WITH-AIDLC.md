...
1. [一般ルール](#1-general-rules)
2. [Inception フェーズ](#2-inception-phase)
3. [Construction フェーズ](#3-construction-phase)
4. [バイブコーディングを絶対にしない](#4-never-vibe-code)
...
文字、ラベルの追加、選択肢の組み合わせ、カスタム回答のための X の使用に関する完全なガイダンスについては [セクション 1](#the-question--doc--approval-flow) の回答ヒントを参照してください。要件分析に特有のいくつかの追加ポイント:
