...
- [共通手順](#common)
- [プラットフォーム別セットアップ](#platform-specific-setup)
- [使い方](#usage)
- [3フェーズ適応型ワークフロー](#three-phase-adaptive-workflow)
- [主な機能](#key-features)
- [拡張機能](#extensions)
- [サポートツール](#supporting-tools)
- [信条](#tenets)
- [前提条件](#prerequisites)
- [トラブルシューティング](#troubleshooting)
- [バージョン管理の推奨事項](#version-control-recommendations)
- [その他のリソース](#additional-resources)
- [生成される aidlc-docs/ リファレンス](#generated-aidlc-docs-reference)
- [実験的機能: AIによるセットアップ支援（リリースのダウンロード）](#experimental-ai-assisted-setup-release-download)
